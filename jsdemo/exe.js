...
function ShowResult(){
    ...
    let person=prompt("ENTER VECHICLE NAME:")
    let OPdiv=document.getElementById("OPDIV")
    if(person==null||person==""){
        OPdiv.innerHTML="user cancelled the prompt!"
        OPdiv.style.color="red"
        OPdiv.style.fontVariant="small-caps"
    }
     else if(person=="cycle"){
            OPdiv.innerHTML=
            `<div>
        ...
        OPdiv.innerHTML="<h1>Please enter a valid name!</h1>"
        OPdiv.style.color="red"
        OPdiv.style.fontVariant="small-caps"
    }
}